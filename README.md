...
Sampling is performed using scale-down and back-in-time approaches, and result for each approach is evaluated with D-statistic index to measure the degree of resemblance. 
